...
namespace MitchellClaimWSApplication
{
    [ServiceContract]
    public interface IClaimService
    {
        ...
        /// </summary>
        [OperationContract]
        [WebInvoke(Method = "POST", UriTemplate = "/CreateClaim/{MitchellClaimXML}",
        ...
        /// </summary>
        [OperationContract]
        [WebGet(UriTemplate = "/GetClaimByClaimNumber/{claimNumberField}", ResponseFormat = WebMessageFormat.Xml)]
        ...
        /// </summary>
        [OperationContract]
        [WebGet(UriTemplate = "/GetClaimsBetweenDates/{lossDate1}/{lossDate2}", ResponseFormat = WebMessageFormat.Xml)]
